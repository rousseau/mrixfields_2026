...
**Date** : 2026-08-29
**Verdict** : **corrigée en partie, et pour la première fois de façon
significative** — nRMSE 0.3737 → 0.3525 sur R-best, 40 victoires sur 60 paires,
test des signes p = 0.0135, Wilcoxon p = 0.0225. Structure inchangée.
